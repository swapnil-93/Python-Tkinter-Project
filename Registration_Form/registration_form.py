...
# Assign a name to sheet
sheet.title="excel.xlsx"

# laod the existing excel file
# wb = load_workbook('C:\\Users\\Tanu-PC\\Documents\\Online_Python\\excel.xlsx')
...
def insert():
    ...
    if (name_field.get() == "" and
        ...
        # save the file
        wb.save('C:\\Users\\Tanu-PC\\Documents\\Online_Python\\excel.xlsx')
